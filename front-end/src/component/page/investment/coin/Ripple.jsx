...
function Ripple(){
    ...
    useEffect(() => {
      const fetchBitcoinData = async () => {
        const url = 'https://api.binance.com/api/v3/klines?symbol=XRPUSDT&interval=1d&limit=30';
        try {
    ...
    <div className="Stock_kospi">
        ...
        <ResponsiveContainer width={200} height={150}>
            <LineChart data={stockData} margin={{ top: 5, right: 0, left: 0, bottom: 0 }}>
                ...
                <YAxis domain={[0.46, 0.68]} ticks={null} orientation="left" tick={false} stroke="transparent"/>
